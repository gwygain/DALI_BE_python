...
1. Go to **Account** → **Profile Information**
2. Edit fields:
   - First Name
   - Last Name
   - Phone Number
...
#### **Status Flow Rules**
- Cannot skip statuses (must go PENDING → PROCESSING → SHIPPED → DELIVERED)
...
- **Discount Type**: Choose one:
  ...
  - **Fixed Amount**: Discount as fixed value (e.g., ₱100)
...
- **First Time**: "WELCOME10" - ₱100 off, 1 use per user, min ₱500 order
...
- **Details**: Additional information (old value → new value)
...
- ✅ Check sale page regularly for deals
- ✅ Add products to wishlist (if feature available)
...
- ✅ Keep customer informed of order changes
